                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap gap-6">
                                        <a href="{{ route('admin.paylater.show', $account->id) }}" class="btn btn-primary d-flex justify-content-center align-items-center {{ request()->filter == null ? 'active' : '' }}">All</a>
                                        <a href="{{ route('admin.paylater.show', ['id' => $account->id, 'filter' => 'unpaid']) }}" class="btn btn-warning d-flex justify-content-center align-items-center {{ request()->filter == 'unpaid' ? 'active' : '' }}">Unpaid</a>
                                        <a href="{{ route('admin.paylater.show', ['id' => $account->id, 'filter' => 'paid']) }}" class="btn btn-success d-flex justify-content-center align-items-center {{ request()->filter == 'paid' ? 'active' : '' }}">Paid Off</a>
