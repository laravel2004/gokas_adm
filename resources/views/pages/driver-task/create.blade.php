                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div>
                                ...
                                <select name="start_pick_point_id" class="form-select" aria-label="Default select example">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div>
                                ...
                                <select name="end_pick_point_id" class="form-select" aria-label="Default select example">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <input type="date" name="start_date" class="form-control" id="exampleInputfirstname4" />
                            </div>
                            <div class="mb-4">
                                <label for="exampleInputfirstname4" class="form-label">Start Time</label>
                                <input type="time" name="start_time" class="form-control" id="exampleInputfirstname4" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mb-4">
                                <label for="exampleInputfirstname4" class="form-label">End Date</label>
                                <input type="date" name="end_date" class="form-control" id="exampleInputfirstname4" />
                            </div>
                            <div class="mb-4">
                                <label for="exampleInputfirstname4" class="form-label">End Time</label>
                                <input type="time" name="end_time" class="form-control" id="exampleInputfirstname4" />
                            </div>
                        </div>
                        <div class="col-12">
